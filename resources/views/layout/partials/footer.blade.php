<footer class="bg-primary my-auto">
        <div class="max-w-2xl mx-auto text-white py-10">
                <a href="" class="flex items-center">
                    <img src="{{ asset('/images/RoadWatch Logo WB.png') }}"  class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4" alt="RoadWatch Logo" />
                </a>
            <div class="text-center my-8">
                ...
                <div class="w-36 flex flex-row space-x-8 justify-between mx-auto my-10">
                    <a href="">
                        <img src="{{ asset('/images/facebook.png') }}" class="h-5" alt="Facebook Logo" />
                    </a>
                    <a href="">
                        <img src="{{ asset('/images/twitter.png') }}" class="h-5" alt="Facebook Logo" />
                    </a>
                    <a href="">
                        <img src="{{ asset('/images/instagram.png') }}"class="h-5" alt="Facebook Logo" />
                    </a>
                </div>
            </div>
        </div>
