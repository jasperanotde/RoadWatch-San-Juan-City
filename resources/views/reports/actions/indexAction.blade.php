               ...
               <tbody>
                  ...
                  <tr class="bg-blue-100 border-b">
                     ...
                     <td class="px-5 py-4 w-full border-r">
                        <button data-te-target="#showModal{{ $submission->id }}" data-te-toggle="modal" class="underline text-green-800" type="button" data-te-ripple-init data-te-ripple-color="light">Created date: {{ $submission->created_at->format('F j, Y') }}</button>
                     </td>

                     <!-- Update Button -->
                     <td class="px-5 py-4 w-1/2 bg-red-100 hover:bg-gray-200">
                        <button class="inline-flex items-center px-4 py-2 bg-green-600 hover:bg-green-700 text-white text-sm font-medium rounded-md" type="button" data-te-target="#updateModal" data-te-toggle="modal" data-te-ripple-init data-te-ripple-color="light">
