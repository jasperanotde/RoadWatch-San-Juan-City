      ...
      <div class="w-full md:w-1/2 p-4">
         <div style="border-radius: 10px" id="glass" class="glass border shadow-lg ">
            ...
            <table class="table-auto">
               <tbody>
                  <tr class="bg-blue-100 hover:bg-blue-200 border-b font-semibold">
                     <td  class="px-6 py-4 w-2/5 border-r">Creator Name : </td>
                     <td  class="px-6 py-4 w-3/5 bg-gray-100 text-primary hover:bg-gray-200">{{ $creatorName }}</td>
                  </tr>
            ...
            <div class="flex items-center justify-between p-4">
               ...
               @endif
               @if($report->status === 'INPROGRESS')
                  <span class="px-6 py-4 italic font-italic text-red-700 font-semibold text-sm"><span class="text-primary">Start: </span>{{ $startDate }} <span class="text-primary">| Target End: </span> {{ $targetDate }}</span>
               @endif
            </div>
         </div>
...
<!-- Action Slip Blades -->
@include('reports.actions.indexAction')
@include('reports.actions.createAction')
@endsection
