            ...
            <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                ...
                <tbody>
                    ...
                    <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                        ...
                        <td class="px-6 py-4">
                            <button class="inline-flex items-center px-4 py-2 bg-gray-200 hover:bg-gray-300 text-gray-800 text-sm font-medium rounded-md" type="button" data-te-target="#showRoleModal{{ $role->id }}" data-te-toggle="modal" data-te-ripple-init data-te-ripple-color="light">
                            ...
                            @can('role-edit')
                            <button class="inline-flex items-center px-4 py-2 bg-green-600 hover:bg-green-700 text-white text-sm font-medium rounded-md" type="button" data-te-target="#editRoleModal{{ $role->id }}" data-te-toggle="modal" data-te-ripple-init data-te-ripple-color="light">
                            ...
                            @can('role-delete')
                            <button class="inline-flex items-center px-4 py-2 bg-red-600 hover:bg-red-700 text-white text-sm font-medium rounded-md" type="button" data-te-target="#deleteRoleModal{{ $role->id }}" data-te-toggle="modal" data-te-ripple-init data-te-ripple-color="light">
                                    <svg xmlns="http://www.w3.org/2000/svg" class="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
